...
if __name__ == "__main__":
    ...
    print("🔐 Auth: POST /login (5-minute sessions)")
    print("👥 Students: Full CRUD operations")
    print("✅ Todos: Full CRUD operations")
    print("🩺 Health: GET /health (continuous monitoring)")
    print("📊 Status: GET /status (session info)")
    print("="*60)
    ...
    print("   • Always requires login for dashboard")
    print("="*60 + "\n")
