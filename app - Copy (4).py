...
# IMPORTANT: Keep table name as 'student' for foreign key compatibility
...
class Todo(SQLModel, table=True):
    ...
    # Foreign key references 'student' table (matching actual table name)
    student_id: Optional[int] = Field(
        default=None, 
        foreign_key="student.id"  # References the actual 'student' table
    )
